...
#include "sdk/linuxsdk/src/jni/audio_device/audio_device_module.h"
...
#include "sdk/linuxsdk/generated_audio_device_module_base_jni/jni/WebRtcAudioManager_jni.h"
...
class LinuxsdkAudioDeviceModule : public AudioDeviceModule {
 public:
  ...
  LinuxsdkAudioDeviceModule(AudioDeviceModule::AudioLayer audio_layer,
  ...
  ~LinuxsdkAudioDeviceModule() override { RTC_LOG(INFO) << __FUNCTION__; }
  ...
  int32_t SetStereoPlayout(bool enable) override {
    RTC_LOG(INFO) << __FUNCTION__ << "(" << enable << ")";
    // Linuxsdk does not support changes between mono and stero on the fly. The
  ...
  // Not implemented for any input device on Linuxsdk.
...
rtc::scoped_refptr<AudioDeviceModule> CreateAudioDeviceModuleFromInputAndOutput(
    ...
    std::unique_ptr<AudioOutput> audio_output) {
  RTC_LOG(INFO) << __FUNCTION__;
  return new rtc::RefCountedObject<LinuxsdkAudioDeviceModule>(
